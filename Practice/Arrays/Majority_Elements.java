...
//    }
    ...
    // let there will be 2 such elements check for their count during iteration then on ending of loop check back those elements whether they are greater than the required level
    public static List<Integer> majorityElement(int[] nums){
        List<Integer> ansList = new ArrayList<>();
